        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <div className="blog-item padd-15">
              <div className="blog-item-inner shadow-dark">
                <div className="blog-img">
                  <img src="/imgs/blog/cityvet.jpg" alt="Responsive Web Design" />
            ...
            <div className="blog-item padd-15">
              <div className="blog-item-inner shadow-dark">
                <div className="blog-img">
                  <img src="/imgs/blog/buksucaps.jpg" alt="Creative Slideshow" />
            ...
            <div className="blog-item padd-15">
              <div className="blog-item-inner shadow-dark">
                <div className="blog-img">
                  <img src="/imgs/blog/ebrangay.png" alt="Image Gallery Lightbox" />
                  <div className="blog-date">June 4, 2023</div>
                </div>
                <div className="blog-info">
                  <h4 className="blog-title">
